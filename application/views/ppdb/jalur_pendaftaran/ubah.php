				...
				<div class="col-md-8 offset-2">
					<form method="POST">
						<div class="form-group">
							...
							<input type="text" id="nama_jalur_pendaftaran" name="nama_jalur_pendaftaran" class="form-control nama_jalur_pendaftaran <?php if(form_error('nama_jalur_pendaftaran')) echo 'is-invalid'?>" placeholder="Nama Jalur Pendaftaran" value="<?php echo $jalur['nama_jalur_pendaftaran'] ?>">
