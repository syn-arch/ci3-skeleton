				...
				<div class="col-md-8 offset-2">
					...
					<form method="POST" enctype="multipart/form-data">
						<div class="form-group">
							...
							<input type="text" id="judul" name="judul" class="form-control judul <?php if(form_error('judul')) echo 'is-invalid'?>" placeholder="Judul" value="<?php echo $slider['judul'] ?>">
							<?php echo form_error('judul', '<small style="color:red">','</small>') ?>
						</div>
						<div class="form-group">
							<label for="keterangan">Keterangan</label>
							<textarea name="keterangan" id="keterangan" cols="30" rows="10" class="form-control <?php if(form_error('keterangan')) echo 'is-invalid'?>" placeholder="Keterangan"><?php echo $slider['keterangan'] ?></textarea>
						...
						<div class="form-group">
							<img src="<?php echo base_url('assets/img/slider/') . $slider['gambar'] ?>" alt="" class="img-fluid">
						</div>
						<div class="form-group">
