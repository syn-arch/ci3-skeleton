				...
				<div class="col-md-8 offset-2">
					...
					<form method="POST" enctype="multipart/form-data">
						<div class="form-group">
							...
							<input type="text" id="slug" name="slug" class="form-control slug <?php if(form_error('slug')) echo 'is-invalid'?>" placeholder="Slug" value="<?php echo $berita['slug'] ?>">
							<?php echo form_error('slug', '<small style="color:red">','</small>') ?>
						</div>
						<div class="form-group">
							<label for="judul">Judul</label>
							<input type="text" id="judul" name="judul" class="form-control judul <?php if(form_error('judul')) echo 'is-invalid'?>" placeholder="Judul" value="<?php echo  $berita['judul'] ?>">
							<?php echo form_error('judul', '<small style="color:red">','</small>') ?>
						</div>
						<div class="form-group">
							<label for="isi_berita">Isi Berita</label>
							<textarea name="isi_berita" id="isi_berita" cols="30" rows="10" class="form-control textarea isi_berita <?php if(form_error('isi_berita')) echo 'is-invalid'?>" placeholder="Tulis Berita..."><?php echo $berita['isi_berita'] ?></textarea>
						...
						<div class="form-group">
							<img src="<?php echo base_url('assets/img/berita/') . $berita['gambar_berita'] ?>" alt="Gambar Berita" class="img-fluid">
						</div>
						<div class="form-group">
